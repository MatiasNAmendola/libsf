...
class int_precision
   ...
   public:
      ...
      int size() const           { return mNumber.length(); } // Return number of digits including he sign
...
#ifdef _INT_PRECISISON_FAST_DIV_REM
