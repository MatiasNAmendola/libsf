...
static char _VF_[] = "@(#)fprecision.h 01.18 -- Copyright (C) Future Team Aps";
...
extern float_precision modf( float_precision, float_precision * );
extern float_precision fmod( float_precision, float_precision );
extern float_precision floor( float_precision );
extern float_precision ceil( float_precision );
extern float_precision fabs( float_precision );
extern float_precision sqrt( float_precision );
extern float_precision log10( float_precision );
extern float_precision log( float_precision );
extern float_precision exp( float_precision );
extern float_precision pow( float_precision, float_precision );
extern float_precision frexp( float_precision, int * );
extern float_precision ldexp( float_precision, int );

// Trigonometric functions
extern float_precision atan( float_precision );
extern float_precision atan2( float_precision, float_precision );
extern float_precision asin( float_precision );
extern float_precision acos( float_precision );
extern float_precision sin( float_precision );
extern float_precision cos( float_precision );
extern float_precision tan( float_precision );

// Hyperbolic functions
extern float_precision sinh( float_precision );
extern float_precision cosh( float_precision );
extern float_precision tanh( float_precision );
extern float_precision asinh( float_precision );
extern float_precision acosh( float_precision );
extern float_precision atanh( float_precision ); 
...
std::string _float_precision_ftoa( float_precision * );
std::string _float_precision_ftoainteger( float_precision * );
...
class float_precision {
   ...
   public:
      ...
      int change_sign()   { // Change and return sign   
	   ...
	   std::string toString()						{ return _float_precision_ftoa(this); }
      ...
      operator double();
      operator float();
 	   operator int_precision();

/*
      template<class T> operator T() { std::string s = _float_precision_ftoa( this ); return (T)atof( s.c_str() ); } 
 */
      // Essential operators
...
///
inline float_precision::operator double()
...
///    Conversion to float
///
inline float_precision::operator float()
   {// Conversion to long
...
///   Conversion to long
///
inline float_precision::operator long()
   {// Conversion to long
...
///   Conversion to int
///
inline float_precision::operator int()
   {// Conversion to int 
...
///   Conversion to short
///
inline float_precision::operator short()
   {// Conversion to short
...
///   Conversion to char
///
inline float_precision::operator char()
   {// Conversion to char
...
///
inline float_precision::operator unsigned long()
   {// Conversion to int 
...
///
inline float_precision::operator unsigned int()
   {// Conversion to int 
...
///
inline float_precision::operator unsigned short()
   {// Conversion to short
...
///
inline float_precision::operator unsigned char()
   {// Conversion to char
...
///
inline float_precision::operator int_precision()
	{// Conversion to int_precision
