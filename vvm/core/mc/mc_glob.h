...
//////
	...
	SAsciiCompSearcher	cgcKeywordOperators[] =
	{
		...
		{ cgcCaskRoundOpenParams,	3,			false,		_MC_ICODE_CASK_ROUND_OPEN_PARAMS,		false,				NULL,					NULL },
		{ cgcCaskRoundCloseParams,	3,			false,		_MC_ICODE_CASK_ROUND_CLOSE_PARAMS,		false,				NULL,					NULL },
		{ cgcCaskSquareOpenParams,	3,			false,		_MC_ICODE_CASK_SQUARE_OPEN_PARAMS,		false,				NULL,					NULL },
		{ cgcCaskSquareCloseParams,	3,			false,		_MC_ICODE_CASK_SQUARE_CLOSE_PARAMS,		false,				NULL,					NULL },
		{ cgcCaskTriangleOpenParams,3,			false,		_MC_ICODE_CASK_TRIANGLE_OPEN_PARAMS,	false,				NULL,					NULL },
		{ cgcCaskTriangleCloseParams,3,			false,		_MC_ICODE_CASK_TRIANGLE_CLOSE_PARAMS,	false,				NULL,					NULL },
		{ cgcCaskTildeOpenParams,	3,			false,		_MC_ICODE_CASK_TILDE_OPEN_PARAMS,		false,				NULL,					NULL },
		{ cgcCaskTildeCloseParams,	3,			false,		_MC_ICODE_CASK_TILDE_CLOSE_PARAMS,		false,				NULL,					NULL },
		{ cgcCaskRoundOpen,			2,			false,		_MC_ICODE_CASK_ROUND_OPEN,				false,				NULL,					NULL },
		{ cgcCaskRoundClose,		2,			false,		_MC_ICODE_CASK_ROUND_CLOSE,				false,				NULL,					NULL },
		{ cgcCaskSquareOpen,		2,			false,		_MC_ICODE_CASK_SQUARE_OPEN,				false,				NULL,					NULL },
		{ cgcCaskSquareClose,		2,			false,		_MC_ICODE_CASK_SQUARE_CLOSE,			false,				NULL,					NULL },
		{ cgcCaskTriangleOpen,		2,			false,		_MC_ICODE_CASK_TRIANGLE_OPEN,			false,				NULL,					NULL },
		{ cgcCaskTriangleClose,		2,			false,		_MC_ICODE_CASK_TRIANGLE_CLOSE,			false,				NULL,					NULL },
		{ cgcCaskTildeOpen,			2,			false,		_MC_ICODE_CASK_TILDE_OPEN,				false,				NULL,					NULL },
		{ cgcCaskTildeClose,		2,			false,		_MC_ICODE_CASK_TILDE_CLOSE,				false,				NULL,					NULL },
