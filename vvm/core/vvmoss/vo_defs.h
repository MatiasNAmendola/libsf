...
inline bool					ioss_verifyLength								(u64 tnGoingTo, u64 tnMaxAllowable);
	...
	void					iioss_getSpannedPixelComputation3				(_isSSpannedPixelProcessing* bp);
	void					iioss_getSpannedPixelComputation4				(_isSSpannedPixelProcessing* bp);
	void					iioss_getSpannedPixelComputation5				(_isSSpannedPixelProcessing* bp);
	void					iioss_getSpannedPixelComputation6				(_isSSpannedPixelProcessing* bp);
