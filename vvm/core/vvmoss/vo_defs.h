...
//////
		...
		SRegion* CALLTYPE		oss_createRegion							(u64 tnAssociatedId, u32 tnType, s32 ulx, s32 uly, s32 lrx, s32 lry, SCallbacks* callbacks, SStartEnd* events, SRegionState* trs);
